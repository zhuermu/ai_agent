...
class HunyuanEmbeddings(Embeddings, BaseModel):
    ...
    hunyuan_secret_id: str = Field(alias="secret_id", default=None)
    """Hunyuan Secret ID"""
    hunyuan_secret_key: str = Field(alias="secret_key", default=None)
    """Hunyuan Secret Key"""
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        hunyuan_secret_id = values["hunyuan_secret_id"].get_secret_value()
        hunyuan_secret_key = values["hunyuan_secret_key"].get_secret_value()
        credential = Credential(hunyuan_secret_id, hunyuan_secret_key)
